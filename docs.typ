#import "template.typ": default_template, dated-li
#import "bib.typ": bib_info_research, bib_info_cv, talk_info_cv
...
#default_template("index", [Home])[
    ...
    Leuven's Institute of Philosophy (Belgium), where I also did my MPhil. I mainly
    work in topics related to (i) the philosophy of modality, specially its
    epistemology and metaphysics, (ii) understanding, and (iii) know-how. I also am
    competent in general epistemology, philosophy of science, philosophy of logic
...
#default_template("research", [Research])[
    #html.div(class: "wrapper")[
        #html.section(class: "main")[
            #html.div(style: "padding-right: 2em")[ //first column
                #html.section[
                    ...
                    #for article in yaml("_data/articles.yml") {
                        if article.at("selected", default: false) and article.selected == true [
                            #html.details()[
                                #html.summary[
            ...
            #html.div[ // second column
                    #html.section(class: "first-section")[
                        #html.h2[#html.small[Postdoctoral project:]#html.br()Saber Cómo: Preguntas, Maneras e Intentos]

                        2022-2025. Universidad de Chile.

                        #link("/assets/postdoc - saber como: preguntas, maneras e intentos - resumen (es).pdf")[Summary (spanish) [pdf]]
                    ...
                    #html.section[
                        #html.h2[#html.small[PhD Thesis]#html.br()Agentive
                        Modality and the Structure of Modal Thought.]    
        ...
        #for talk in yaml("_data/talks.yml") {
            if talk.at("selected", default: false) [
                    #html.div(class: "dated-li")[
                        ...
                        #html.div(class: "dated-li-details")[#talk.title.
...
#default_template("cv", [CV])[
    ...
    #html.section[
        ...
        #html.i(class: "far fa-envelope")[] #html.a(href: "mailto" + personalia.email)[#personalia.email]

        #html.i(class: "fa-brands fa-orcid")[] #link(personalia.orcid)[#personalia.orcid]
        ...
        #html.div(class: "dated-list")[
            #for event in others {
                if event.type == "event" [
                    ...
                    [
                        #let url = ""
                        #if event.at("url", default: "") != "" {url = [. #link(event.url)[#event.url]]} 
...
Incluye preguntas y respuestas seleccionadas, y un apéndice sobre lógica básica.
